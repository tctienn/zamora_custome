    ...
    <form ref='form'>
      <div class='formgrid grid mb-4'>
        ...
        <div class='col-4 field'>
          <label
            class='font-bold'>{{
              t(`hrm.category.numOfMonth`)
            }}</label>
          <div>
            <InputNumber
              v-model='category.numOfMonth'
        ...
        <div class='col-4 field'>
          <label
            class='font-bold'>{{
              t(`hrm.category.template`)
            }}
          </label>
          <NamedDropdown
            id='status'
            v-model='category.template'
            name='template'
...
import { listHdTemplates } from '@/apps/hrm/api/graphql/contract';
...
listHdTemplates().onResult((res) => {
  listTemplates.value = res.data.listHdTemplates;
});
