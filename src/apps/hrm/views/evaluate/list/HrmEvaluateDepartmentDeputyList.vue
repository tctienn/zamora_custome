<template>
  <DataTable
    ...
    <Column
      v-for='col in columnDepartmentDeputyConfig'
      :key='col.key'
...
import { type ColumnConfig, columnDepartmentDeputyConfig, generateHeaderDepartmentDeputyConfig } from '@/apps/hrm/constants/generateHeaderConfig';
import {
  toastError,
  toastSuccess
...
const headerConfig = generateHeaderDepartmentDeputyConfig(t, prevMonth.value, currentMonth.value);
