      ...
      <div class='formgrid grid mb-4'>
        <div class='col'>
          <div class='flex flex-column gap-2 justify-content-end pb-3'>
            <label
              v-required>
              {{ t('mission.jobResult.document.table.name') }}
            </label>
            <InputText
          ...
          <div class='field w-full'>
            <label> {{ t('mission.jobResult.document.table.draftDate') }}</label>
            <div
              class='w-full'>
              <NamedInputCalendar
                v-model='fileDataValue.draftDate'
                format='DD/MM/YYYY'
                ...
                show-icon/>
              <ValidateErrorMessage :errors='vi$.draftDate.$errors'/>
            </div>
          </div>
          <div class='field'>
...
const rules = {
  ...
  draftDate: { required: helpers.withMessage(t('mission.mission.errors.draftDate'), required) },
  attachment: {
