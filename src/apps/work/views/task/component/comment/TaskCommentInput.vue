<template>
  <div class='p-1 p-component p-inputtext p-inputtextarea p-inputtextarea-resizable w-full'>
    ...
    <div class='align-items-center flex h-full justify-content-between'>
      ...
      <Textarea
        v-model='content'
        auto-resize
        class='h-3rem input-no-border overflow-auto px-0 shadow-none w-full'
        :disabled='disabled'
        :maxlength='1000'
        rows='1'
  ...
  <div class='gap-2 grid grid-nogutter relative'>
    ...
    <Badge
      ...
      <span class='text-overflow-ellipsis w-full'>
...
import TaskCommentEdit from '@/apps/work/views/task/component/comment/TaskCommentEdit.vue';
