...
import CommentSidebar from '@/apps/ecm/views/group-documents/components/sidebar/comment-file/CommentSidebar.vue';
import EventBus from '@/common/helpers/event-bus';
import { checkFileTypeViewer, generateFileDownloadUrl, generateFileEditorUrl } from '@/common/helpers/file-utils';
...
const canBack = computed(() => history.length > 1);
...
import EditableViewer from '@/apps/ecm/views/components/view-file/EditableViewer.vue';
