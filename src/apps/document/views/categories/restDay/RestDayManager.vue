...
import { deleteRestDay, duplicateRestDay, searchRestDay, } from '@/apps/document/api/graphql/rest-day';
import { RestDay, type RestDayEdge, type RestDayInterface, } from '@/apps/document/model/restDay';
import RestDayForm from '@/apps/document/views/categories/restDay/RestDayForm.vue';
import RestDayWeekDialog from '@/apps/document/views/categories/restDay/RestDayWeekDialog.vue';
