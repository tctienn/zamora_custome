<template>
  <div
    class='border-round-sm card flex gap-2 m-0 shadow-none w-full'
    style='background: #0D96FA;'>
      ...
      <div class='align-items-center flex justify-content-between'>
        <div class='align-items-center flex justify-content-between'>
          ...
          <router-link
            ...
            to='doc-out'>
            {{ t("document.menu.docForSignature").toUpperCase() }}
          </router-link>
        </div>
          ...
          <div
            ...
            <div class='align-items-center flex flex-grow-1'>
              ...
              <div class='align-items-center flex w-full'>
                <div
                  class='font-bold ml-2 text-white'
...
const search = computed((): DocOutSearch => {
...
const { filteredDocOutMenus, updateCount, updateCountWithPriority } =
  useDocOutMenuConfig(search);
const menusNeedAction = [
  'DocumentDocOutDraftManage',
  'DocumentDocOutWaitingProcessManage',
  'DocumentDocOutProcessingManage',
  'DocumentDocOutSpecialistProcessingManage',
  'DocumentDocOutWaitingProclaimManage',
  'DocumentDocOutWaitingCommentManage',
];
const displayMenus = computed(() =>
  filteredDocOutMenus.value.filter((menu) =>
