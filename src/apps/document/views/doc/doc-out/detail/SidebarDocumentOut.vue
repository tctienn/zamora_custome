<template>
  <Sidebar
      ...
      <div
        ...
        <div
          ...
          <div class='flex gap-1'>
            ...
            <div class='align-content-center font-semibold text-2xl'>{{ t('document.doc.docOut.draftInfo') }}</div>
          </div>
          <div class='flex gap-1'>
            <ButtonIcon
              class='border-round-sm'
    ...
    <form
      ...
      <div class='flex'>
        <div class='pb-5 w-10rem'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.deptName') }}</label>
        </div>
        <div
          class='pb-5'
          :class='incomingDocId ? "w-25rem" : "w-30rem"'>
          {{ userDeptRole.deptName }}
        </div>
        <div>
          <input
        ...
        <div class='pb-5 w-10rem'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.userName') }}</label>
        </div>
        <div
          class='pb-5'
          :class='incomingDocId ? "w-20rem" : "w-30rem"'>
          {{ userDeptRole.userName }}
        </div>
        <input
          v-model='userDeptRole.userId'
          hidden
        ...
        <div
          v-if='incomingDocId'
          class='pb-5 w-10rem'>
          <label class='doc-out-label'>Theo văn bản đến:</label>
        </div>
        <div
          v-if='incomingDocId'
          class='cursor-pointer pb-5 pt-2 relative w-22rem'
      ...
      <div class='flex'>
        <div class='col field px-0 py-1'>
          <label
            v-required
            class='doc-out-label'>{{ t('document.doc.docOut.quote') }}</label>
          <Textarea
            id='quote'
            v-model='doc.quote'
            v-trim
      ...
      <div class='flex py-1'>
        <div class='col-6 field pl-0 py-1'>
          <label
            v-required
            class='doc-out-label'>{{ t('document.doc.docOut.docTypeId') }}</label>
          <NamedDropdown
            v-model='doc.docTypeId'
            class='w-full'
            filter
            :invalid='v$.docTypeId.$errors.length'
        ...
        <div class='col-3 field pl-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.securityCode') }}</label>
          <NamedDropdown
        ...
        <div class='col-3 field px-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.priorityCode') }}</label>
          <NamedDropdown
      ...
      <div class='flex'>
        <div class='col-6 field pl-0 py-1'>
          <label
            v-required
            class='doc-out-label'>{{ t('document.doc.docOut.issuerDept') }}</label>
          <OrganizationTree
            v-model='doc.issuerDept'
            class='p-component w-full'
            :invalid='v$.issuerDeptId.$errors.length'
        ...
        <div class='col-6 field px-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.areaId') }}</label>
          <NamedDropdown
            v-model='doc.areaId'
            class='w-full'
            filter
      ...
      <div class='col px-0 py-1'>
        <UploadFilesGridWithRadio
          ...
          :header='t("document.doc.docOut.mainAttachments")'/>
        <input
          hidden
      ...
      <div class='col px-0'>
        <UploadFilesForDocOut
          ...
          :header='t("document.doc.docOut.otherAttachments")'/>
        <input
          hidden
      ...
      <div class='flex'>
        <div class='col-3 field pl-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.numberOfCopy') }}</label>
          <NamedInputNumber
        ...
        <div class='col-3 field pl-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.numberOfPage') }}</label>
          <NamedInputNumber
        ...
        <div class='col-3 field pl-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.deadlineDate') }}</label>
          <NamedInputCalendar
        ...
        <div class='col-3 field px-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.deadlineNumber') }}</label>
          <NamedInputNumber
      ...
      <div class='flex formgrid gap-2 grid grid-nogutter justify-content-between pb-2'>
        <div class='align-content-end'>
          <label class='doc-out-label font-semibold'>{{ t("document.doc.docOut.receive") }}</label>
        </div>
        <div class='flex gap-1'>
          <ButtonIcon
            v-tooltip.top="'Chọn'"
            class='border-round-sm p-button-icon-only'
            icon='add'
        ...
        <div class='col flex gap-2'>
          <DataTable
            ...
            <Column
              ...
              class='border-1 border-gray-300 text-center w-5rem'
              :header='t("common.ordinalNumber")'
              header-class='border-1 border-gray-300 '>
              <template #body='{index}'>
                {{ index + 1 }}
              </template>
            </Column>
            ...
            <Column
              :header='t("document.doc.docOut.userDeptReceive")'
              header-class='text-center col-8 border-1 border-gray-300'>
            ...
            <Column
              class='col-2'
              :header='t("document.doc.docOut.type")'
              header-class='text-center border-1 border-gray-300'>
      ...
      <div class='col field pb-1 pt-4 px-0'>
        <label class='doc-out-label'>{{ t('document.doc.docInDetail.flow') }}</label>
        <div class='col flex flex-column gap-1 px-0 py-1'>
          <div class='flex gap-4'>
            <label class='align-items-center cursor-pointer doc-out-label flex gap-2'>
              <RadioButton
      ...
      <div class='flex'>
        <div class='col-6 field px-0 py-1'>
          <label class='doc-out-label'>{{ t('document.doc.docOut.advice') }}</label>
          <Textarea
            v-model='doc.advice'
            v-trim
            class='w-full'
        ...
        <div class='col-6 field py-1'>
          <div class='flex flex-column gap-2'>
            ...
            <div class='flex gap-2'>
              ...
              <label class='doc-out-label'>{{ t('document.doc.docOut.isReply') }}</label>
            </div>
            ...
            <div class='flex gap-2'>
              ...
              <label class='doc-out-label'>{{ t('document.doc.docOut.isLawDocument') }}</label>
            </div>
          </div>
        </div>
      </div>
...
onMounted(async () => {
  ...
  const inputEl = document.getElementById('quote') as HTMLInputElement;
  if (inputEl) {
    inputEl.focus();
  }
});
...
<script lang='ts'>
export default { name: 'SidebarDocumentOut' };
</script>
